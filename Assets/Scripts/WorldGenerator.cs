...
public class WorldGenerator {
    ...
    public static Pixel[,] GenerateWorld(int xSize, int ySize, int MinimumNumberOfCircles, int MaximumNumberOfCircles) {
        ...
        double[,] oilPercentageData = GeneratePercentageArray(xSize, ySize, MinimumNumberOfCircles*40, MaximumNumberOfCircles * 40, new Random().Next(7, 10), .95d);
        double[,] goldPercentageData = GeneratePercentageArray(xSize, ySize, MinimumNumberOfCircles * 40, MaximumNumberOfCircles * 40, new Random().Next(10, 60), .95d);
